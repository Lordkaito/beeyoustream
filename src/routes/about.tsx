  ...
  return (
    <Layout>
      ...
      >
        {/* prettier-ignore */}
        <p>
            beeYOU is a free HTML/CSS landing page designed and developed by <a href="https://twitter.com/pacovitiello">@pacovitiello</a> and <a href="https://twitter.com/DavidePacilio">@DavidePacilio</a>!
          </p>
        <p>
